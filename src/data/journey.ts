...
<meta name="description" content="UI部品の名前を実例つきで学べる図鑑">`,
    ...
    },
    {
      ...
      passRate: 0.8,
      deepDive:
        "SEOは「作ったものを、必要な人に届ける」ための技術。どれだけ良いサイトも、見つけてもらえなければ始まらない。そして気づいたかな——SEOの中身は、セマンティックHTML・速さ・レスポンシブ…と、上級で学んできたことの総まとめなんだ。“いいものを正しく作る”が、そのまま“届く”につながる。さあ、いよいよ本当の最終章。AIとの組み方を身につけて、全コース制覇だ！",
      questions: [
        {
          prompt: "SEOとは？",
